...
const ChatbotWidget = () => {
  ...
  return (
    ...
    >
      ...
      {!isOpen && (
        <GlowingFab color="primary" aria-label="chat" onClick={toggleChat} sx={{ mr: 1 }}> {/* Added mr: 1 for gap, Using GlowingFab */}
          <ChatIcon />
        </GlowingFab>
      )}
                  ...
                  >
                    <Paper
                      ...
                      sx={{
                        p: 1,
                        borderRadius: '20px',
                        backgroundColor: message.sender === 'user' ? theme.palette.primary.light : 'white',
                   ...
                   {message.sender === 'bot' && (
                      <Avatar sx={{ bgcolor: theme.palette.secondary.main, ml: 1, order: -1 }}>
                        {getInitials('bot')}
                      </Avatar>
                    )}
                </Box>
